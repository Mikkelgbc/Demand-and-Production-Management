...
Assume you decide to fit the model descriped in the text. What sort of ARIMA model is this (i.e., what are p, d, and q)?
...
We here see a clear upward trend with high seasonality and changing randomsnes trough-out the time serie.
...
It's seems like a worse forecast looking at the higher RMSE value compared tot the ARIMA model.
...
The residual appear to be uncorrelated and normally distributed.
